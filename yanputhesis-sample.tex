...
\documentclass[lang=chs, degree=phd, blindreview=true, winfonts=true, academic=true]{yanputhesis}
...
\advisorAcademicRank{\blindreview{~教授}}{\blindreview{Professor}}						  % 导师中英学术职位（教授 Professor、副教授 Associate Professor、研究员 Researcher 和讲师 Lecturer）
\studentnumber{\blindreview{2026123456}}                                  % 学号
\schoolcode{\blindreview{10699}}                                              % 学校代码
...
\makeCommitteePage{                                         % 学位论文评阅人
    ...
    \committee{20XX 年 X 月 X 日}{
        \defenseChair{\blindreview{赵钱孙}}{\blindreview{教授}}{\blindreview{西北工业大学}}
        \committeeMember{\blindreview{周吴郑}}{\blindreview{教授}}{\blindreview{西北工业大学}}
        \committeeMember{\blindreview{冯陈褚}}{\blindreview{教授}}{\blindreview{西北工业大学}}
        \committeeMember{\blindreview{蒋沈韩}}{\blindreview{教授}}{\blindreview{西北工业大学}}
        \committeeMember{\blindreview{朱秦尤}}{\blindreview{教授}}{\blindreview{西北工业大学}}
        \defenseSecretary{\blindreview{金魏陶}}{\blindreview{教授}}{\blindreview{西北工业大学}}
    }
}
%%-----------------------------------------------------------------------------%
